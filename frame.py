...
class Frame:
    ...
    def process(self): 
        ...
        self.refine_camera(pix_lines, retrieved_image, retrieved_homography)
        self.calculate_2d_coordinates()
    ...
    def calculate_2d_coordinates(self): 
    ...
    def save(self, pix_lines):
        cv2.imwrite('./output_images/{}_original.jpg'.format(self.i), self.original)
        cv2.imwrite('./output_images/{}_pix2pix.jpg'.format(self.i), pix_lines)
